  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="emergency-card text-center">
        <p className="text-secondary text-sm uppercase tracking-widest mb-1">Blood Group</p>
      ...
      {conditions.length > 0 && (
        <div className="card">
          <h3 className="text-sm font-semibold text-secondary uppercase tracking-wider mb-3">⚠️ Critical Conditions</h3>
      ...
      {data.allergies && (
        <div className="emergency-card">
          ...
          <p className="text-primary font-medium">{data.allergies}</p>
        </div>
      )}
      ...
      {data.current_medications && (
        <div className="card">
          <h3 className="text-sm font-semibold text-secondary uppercase tracking-wider mb-2">💊 Current Medications</h3>
          <p className="text-primary">{data.current_medications}</p>
        </div>
      )}
      ...
      {data.emergency_contact_name && (
        <div className="card border-green-500/30">
          ...
          <p className="font-semibold text-primary">{data.emergency_contact_name}</p>
      ...
      {data.doctor_name && (
        <div className="card border-blue-500/30">
          ...
          <p className="font-semibold text-primary">{data.doctor_name}</p>
