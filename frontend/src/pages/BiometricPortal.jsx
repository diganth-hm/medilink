    ...
    <div className="min-h-screen pt-24 pb-12 px-4">
      <div className="max-w-4xl mx-auto">
        <header className="mb-12">
          <h1 className="text-4xl font-bold text-primary mb-3">Biometric Access Portal</h1>
          <p className="text-secondary">Instant access to critical patient medical history using secure biometric authentication.</p>
        </header>
            ...
            <div className="glass p-8 rounded-3xl border border-slate-700/50">
              ...
              <div className="space-y-6">
                ...
                <div className="p-6 bg-slate-800/50 rounded-2xl border border-dashed border-slate-600 text-center">
                  <p className="text-xs text-secondary mb-4 uppercase tracking-tighter font-bold">Waiting for Fingerprint...</p>
          ...
          <div className="lg:col-span-2">
            {!record ? (
               <div className="h-full glass rounded-3xl border border-slate-700/50 flex flex-col items-center justify-center text-center p-12 order-dashed border-slate-700">
                  ...
                  <h3 className="text-xl font-bold text-secondary mb-2">No Record Selected</h3>
                  <p className="text-secondary max-w-xs mx-auto">Please enter a Patient ID and complete biometric verification to access data.</p>
               </div>
            ) : (
              <div className="glass p-8 rounded-3xl border border-blue-500/30 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex justify-between items-start mb-8 pb-8 border-b border-slate-700/50">
                   <div>
                      <h2 className="text-2xl font-bold text-primary mb-1">{record.user_name}</h2>
                      <p className="text-secondary text-sm">Patient Medical Profile</p>
                   </div>
                      ...
                      <section>
                         ...
                         <div className="space-y-2">
                            <div className="flex justify-between text-sm">
                               <span className="text-secondary">Chronic Conditions</span>
                               <span className="text-primary font-medium">{record.chronic_conditions || 'None'}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                   ...
                   <div className="space-y-6">
                      <section>
                         ...
                         <div className="p-4 bg-slate-800/40 rounded-xl border border-slate-700/50">
                            <p className="text-primary font-bold mb-1">{record.emergency_contact_name}</p>
                ...
                <div className="mt-12 p-6 rounded-2xl bg-blue-500/5 border border-blue-500/10">
                   <h4 className="text-sm font-bold text-primary mb-4">Current Medications</h4>
                   <p className="text-secondary text-sm italic">{record.current_medications || 'No current medications recorded.'}</p>
                </div>
              </div>
            )}
          </div>
