    ...
    <div className="min-h-screen text-slate-900 dark:text-slate-100">
      ...
      <div className="relative overflow-hidden pt-12 pb-20 px-4">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl sm:text-7xl font-black text-slate-900 dark:text-white mb-6 leading-tight">
      ...
      <div className="px-4 py-16 max-w-5xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">Every Emergency, Covered</h2>
          <p className="text-slate-600 dark:text-slate-300">MediLink stores data for all critical medical scenarios</p>
        </div>
      ...
      <div className="px-4 py-16 max-w-5xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">How MediLink Saves Lives</h2>
        </div>
      ...
      <div className="px-4 py-20 max-w-3xl mx-auto text-center">
        <div className="card bg-gradient-to-br from-blue-900/40 to-violet-900/40 border-blue-500/20">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Set Up Your Medical Profile Today</h2>
